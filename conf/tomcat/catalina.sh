...
JAVA_OPTS="$JAVA_OPTS -Djavax.sql.DataSource.Factory=org.apache.tomcat.dbcp2.dbcp.BasicDataSourceFactory"
...
CATALINA_OPTS="$CATALINA_OPTS -Dtomcat.port=$TOMCAT_PORT"
CATALINA_OPTS="$CATALINA_OPTS -Djolokia.username=$JOLOKIA_USERNAME"
CATALINA_OPTS="$CATALINA_OPTS -Djolokia.password=$JOLOKIA_PASSWORD"
